...
//
import ptj101 from '../media/web101.png';
import xlptj101 from '../media/xl101.png';
import trw from '../media/webtrw.png';
import xltrw from '../media/xltrw.png';
...
export default function Projects() {
  let [popupNine, setPopupNine] = useState(false);
  let [popupEight, setPopupEight] = useState(false);
  ...
  return (
    <div className='Projects'>
        ...
        <div className='row m-auto px-3 '>
            ...
            <div className='card'>
              ...
              <div className='card-body'>
                <p className='cardText'>
                  Tech Risers <br className='d-block d-lg-none' />
                  Women
                </p>
          ...
          <div className='col-sm-6 col-lg-4'>
            <div className='card'>
              ...
              <div className='card-body'>
                <p className='cardText'>
                  101 Part-Time <br className='d-block d-lg-none' />
                  Jobs
                </p>
                <p className='cardicon'>
                  <PiFileHtml /> <PiFileCss /> <PiFileJs /> <SiReact />{' '}
                  <LuLibrary /> <LuGithub /> <TbBrandNextjs />
                </p>
                <a
      ...
      <div className='popups'>
        <Popup
          trigger={popupNine}
          setTrigger={setPopupNine}>
          <div className='row'>
            <div className='col-5 d-none d-lg-block'>
              <img
                src={xltrw}
                className='xlimage'
                alt='webpage Tech Risers Women initiative'
              />
            </div>
            <div className='col col-lg-7 popupcontent'>
              ...
              <div className='popupText'>
                ...
                Build a responsive website for a initiative for women in tech,
                given three main pillars and a rough colour scheme <br />
                <div className='mt-2 text-decoration-underline popuphighlight'>
                  Achieved:
                </div>
                Sarah from Ladies who code approached me to create a Front-End
                to her new idea of Tech Risers Women. I was excited to be part
                of this project so I tried to put as much love into this website
                as possible and decided to use images of the most influential
                women in tech to showcase the vision. I made a rough design and
                then developed the website and created the content. This project
                means a lot to me and I am so happy to be part of it.
                <a
                  href='https://techriserswomen.com/'
                  target='_blank'
                  rel='noreferrer'
                  ...
                  launch Tech Risers Women website
                </a>
              </div>
            </div>
          </div>
        ...
        <Popup
          trigger={popupEight}
          setTrigger={setPopupEight}>
          <div className='row'>
            <div className='col-5 d-none d-lg-block'>
              <img
                src={xlptj101}
                className='xlimage'
                alt='webpage about music podcast'
              />
            </div>
            <div className='col col-lg-7 popupcontent'>
              ...
              <div className='popupText'>
                ...
                Collaborate on the upkeep, extension and constant update of
                established music podcast website
                <br />
                <div className='mt-2 text-decoration-underline popuphighlight'>
                  Achieved:
                </div>
                Since I am a big fan of 101 part-time jobs, I was approached by
                Tom to be part of the upkeep of the website. This website was
                already developed by Tom with Next.js and I learned a lot
                starting to do smaller projects. My latest contributions were
                helping to work on the pagination function, building a new audio
                player and creating a new "about the host" page. This is an
                ongoing fun project and I am excited to learn more on this
                journey
                <a
                  href='https://www.101parttimejobs.com/'
                  target='_blank'
          ...
          <div className='row'>
            ...
            <div className='col col-lg-7 popupcontent'>
              ...
              <div className='popupText'>
                ...
                homepage. The aim was to design the page based on her latest
                novel, the colour scheme was dark and gloomy and to greet the
                visitor I constructed a flashing light in the windows of the
                lakehouse, which proved harder than expected given the png
                wouldn't load before the flashing windows at first, but I was
                very proud, once it worked and gave the page a bit of a scary
                entry. Exactly what we planned for. I added a slideshow to
                showcase her Books and an extra section to present her reviews,
                which was important to her. During this project I learned a lot
                about Routers and Naviation and dived deep into the magic that
                can be created with React.
                <a
                  href='https://www.janecorryauthor.com/'
                  target='_blank'
                  rel='noreferrer'
